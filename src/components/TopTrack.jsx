...
function TopTrack({ item }) {
  ...
  return (
    <div className="p-2 hover:bg-zinc-800 flex rounded-md">
      ...
      <button className="w-56 sm:w-44 h-10 self-center rounded-full bg-[#ff4a01] flex justify-center items-center hover:bg-[#ff672b] shadow-2xl shadow-zinc-600 text-sm sm:text-base">
        Tune into &nbsp;
        <MdArrowForward />
      </button>
    </div>
